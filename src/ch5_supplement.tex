...
\[
k_{\!B}(T_e+T_i) = \frac{\mu_0 I^2}{8\pi N} = \frac{4\pi\times10^{-7}\times10^{10}}{8\pi\times10^{19}} = \frac{4\times10^{3}}{8\times10^{19}}\times10^{-7} = \frac{4\times10^{-4}}{8\times10^{19}}\times10^{-7}
\]
\[
