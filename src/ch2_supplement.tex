...
\textbf{(3) 德拜球内粒子数：}
\[
N_D = n_e \cdot \frac{4}{3}\pi \lambda_D^3 = 10^{18}\times \frac{4}{3}\pi\times(1.49\times 10^{-5})^3 \approx 1.4\times 10^{4}
\]

\textbf{判断：} $N_D\gg 1$（德拜球内约 $1.4$ 万个粒子）且 $\lambda_D\ll L$（实验室装置尺度 $L\sim 0.1\,\mathrm{m}$），满足理想等离子体条件。
\end{example}
...
\]
判据 (iii)：库仑作用势能与热能之比 $\Gamma = \frac{e^2}{4\pi\eps_0\lambda_D k_{\!B}T_e}$。由于 $N_D\gg 1$，等价于 $\Gamma\ll 1$。此处 $N_D\approx 1.16\times10^4$，故 $\Gamma \sim N_D^{-2/3}\approx 2\times10^{-3}\ll 1$，弱耦合成立（若按 $\Gamma = N_D^{-1}$ 估算亦为 $\sim10^{-4}$，同样远小于 $1$）。
...
\textbf{星际介质：}
\[
\lambda_D = \sqrt{\frac{8.854\times 10^{-12}\times 0.86\times 1.602\times 10^{-19}}{10^6\times (1.602\times 10^{-19})^2}} \approx 6.89\,\mathrm{m}
\]
\[
\omega_{pe} = \sqrt{\frac{10^6\times (1.602\times 10^{-19})^2}{8.854\times 10^{-12}\times 9.109\times 10^{-31}}} \approx 5.64\times 10^{4}\,\mathrm{rad/s}\;(f_{pe}\approx 9.0\,\mathrm{kHz})
\]
\[
N_D = \frac{4}{3}\pi\times 10^6\times (6.89)^3 \approx 1.4\times 10^{9}
\]

\textbf{实验室低温：}（见例题 \ref{ex:low-temp-params}）
$\lambda_D\approx 14.9\,\mu\mathrm{m}$，$\omega_{pe}\approx 5.64\times 10^{10}\,\mathrm{rad/s}$，$N_D\approx 1.4\times 10^4$。

\textbf{磁约束聚变：}
\[
\begin{aligned}
\lambda_D &= \sqrt{\frac{8.854\times 10^{-12}\times 10^4\times 1.602\times 10^{-19}}
                        {10^{20}\times (1.602\times 10^{-19})^2}}
          = \sqrt{\frac{1.418\times 10^{-26}}{2.566\times 10^{-21}}} \\
          &\approx 7.4\times 10^{-5}\,\mathrm{m} = 74\,\mu\mathrm{m}
\end{aligned}
\]
\[
\omega_{pe} = \sqrt{\frac{10^{20}\times 2.566\times 10^{-38}}{8.065\times 10^{-42}}} \approx 5.64\times 10^{11}\,\mathrm{rad/s}\;(f_{pe}\approx 89.8\,\mathrm{GHz})
\]
\[
N_D = \frac{4}{3}\pi\times 10^{20}\times (7.4\times 10^{-5})^3 \approx 1.7\times 10^{8}
\]
...
\begin{formulabox}{第2章核心公式速查}{ch2-formulas}
\begin{itemize}[leftmargin=*,itemsep=0pt]
...
\item 德拜球粒子数：$\displaystyle N_D = \frac{4\pi}{3} n_e \lambda_D^3 \gg 1$（理想等离子体判据）
...
\begin{checklistbox}{第2章自学检查清单}{ch2-checklist}
