...
\item 该扰动的增长率 $\gamma$；
\item 扰动振幅增长 $10$ 倍（$\ee$  foldings）所需的时间；
...
此处 $u$ 较大而离子静止，近似为单束流不稳定性，最大增长率约为：
\[
\gamma_{\max} \approx \frac{\omega_{pe}}{2} = 2.5\times 10^{10}\,\mathrm{rad/s}
\]

对应增长时间：
\[
\tau = \frac{1}{\gamma_{\max}} = 4\times 10^{-11}\,\mathrm{s} = 40\,\mathrm{ps}
\]
