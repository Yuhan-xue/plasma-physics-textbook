...
库仑对数定义为 $\ln\Lambda = \ln(12\pi N_D)$，其中德拜球内粒子数 $N_D = \frac{4\pi}{3} n_e \lambda_D^3$。另一种常用形式是
\[
\Lambda = \frac{\lambda_D}{b_0} = \frac{12\pi\eps_0 k_{\!B}T_e}{e^2 n_e^{1/3}}
\]

对典型等离子体，$\ln\Lambda$ 在 $10$--$30$ 之间。下面用 $N_D = \frac{4\pi}{3} n_e \lambda_D^3$ 计算。
...
\]
\[
\ln\Lambda = \ln(12\pi\times 1.39\times 10^4) = \ln(5.24\times 10^5) \approx 13.2
\]
...
\]
\[
\ln\Lambda = \ln(12\pi\times 1.72\times 10^9) = \ln(6.48\times 10^{10}) \approx 24.9
\]
...
\]
\[
\ln\Lambda = \ln(12\pi\times 1.72\times 10^8) = \ln(6.48\times 10^9) \approx 22.6
\]

\textbf{规律总结：}
\begin{itemize}[leftmargin=*,itemsep=0pt]
\item $\ln\Lambda$ 对等离子体参数的变化极为缓慢：跨越十几个数量级的密度和温度，$\ln\Lambda$ 仅从约 $13$ 变到约 $25$。
